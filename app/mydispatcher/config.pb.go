...
var file_app_mydispatcher_config_proto_goTypes = []interface{}{
	(*SessionConfig)(nil), // 0: nodex.app.mydispatcher.SessionConfig
	(*Config)(nil),        // 1: nodex.app.mydispatcher.Config
}
var file_app_mydispatcher_config_proto_depIdxs = []int32{
	0, // 0: nodex.app.mydispatcher.Config.settings:type_name -> nodex.app.mydispatcher.SessionConfig
